class MealWeekPlanAdminCard extends HTMLElement{
  ...
  specialDishes(){return[{id:'__away__',name:'Wir sind nicht da!',special:true,image_url:'/meal_vote_static/special-away.webp?v=0.6.26'},{id:'__bread__',name:'Brot',special:true,image_url:'/meal_vote_static/special-bread.webp?v=0.6.26'}];}
  activeDishes(){
  ...
  render(){
    ...
    </style><ha-card><div class="weekShell"><div class="head"><h2>🛠️ Wochenplan verwalten</h2><span class="badge">UI 0.6.26</span><button id="reload" class="clear">↻</button></div>
