...
Dashboard-Ressource: `/meal_vote_static/meal-vote-card.js?v=0.6.7`
...
### Wochenplan (v0.6.7)
Zusätzliche Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.6.7`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.6.7`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-admin-card.js?v=0.6.7`

Nur die Admin-Karte enthält Bearbeiten, Löschen, „＋ Gericht“ und den Wocheneinkauf.


### Rezepte und mehrere Kategorien (v0.6.7)
...
### Copy-&-Paste-Rezeptimport (v0.6.7)
