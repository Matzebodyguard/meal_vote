...
Dashboard-Ressource: `/meal_vote_static/meal-vote-card.js?v=0.6.24`
...
### Wochenplan (v0.6.24)
Zusätzliche Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.6.24`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.6.24`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-admin-card.js?v=0.6.24`

Nur die Admin-Karte enthält Bearbeiten, Löschen, „＋ Gericht“ und den Wocheneinkauf.


### Rezepte und mehrere Kategorien (v0.6.24)
...
### Copy-&-Paste-Rezeptimport (v0.6.24)
...
### Icon
Ab v0.6.24 liegt ein quadratisches Installations-/Repository-Icon als `icon.png` im Repository sowie im Integrationsordner bei. Für die offizielle Anzeige des Icons in Home Assistant/HACS kann das Icon zusätzlich im Home-Assistant-Brands-Repository für die Domain `meal_vote` hinterlegt werden.


### Lokaler Speichermodus (v0.6.24)
...
### Automatische Speichermigration (v0.6.24)
...
### Lokales Home-Assistant-Branding (v0.6.24)
