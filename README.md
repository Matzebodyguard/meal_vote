...
Dashboard-Ressource: `/meal_vote_static/meal-vote-card.js?v=0.5.4`
...
### Wochenplan (v0.5.4)
Zusätzliche Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.5.4`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.5.4`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-admin-card.js?v=0.5.4`

Nur die Admin-Karte enthält Bearbeiten, Löschen, „＋ Gericht“ und den Wocheneinkauf.


### Rezepte und mehrere Kategorien (v0.5.4)
