...
Dashboard-Ressource: `/meal_vote_static/meal-vote-card.js?v=0.5.3`
...
### Wochenplan (v0.5.3)
Zusätzliche Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.5.3`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.5.3`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-admin-card.js?v=0.5.3`
