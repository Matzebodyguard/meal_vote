...
Dashboard-Ressource: `/meal_vote_static/meal-vote-card.js?v=0.6.9`
...
### Wochenplan (v0.6.9)
Zusätzliche Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.6.9`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-card.js?v=0.6.9`
...
grid_options:
  columns: full
```
Ressource: `/meal_vote_static/meal-week-plan-admin-card.js?v=0.6.9`

Nur die Admin-Karte enthält Bearbeiten, Löschen, „＋ Gericht“ und den Wocheneinkauf.


### Rezepte und mehrere Kategorien (v0.6.9)
...
### Copy-&-Paste-Rezeptimport (v0.6.9)
